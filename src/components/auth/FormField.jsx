    ...
    <div className="group space-y-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={onChange}
          required={required}
          className={`h-9 w-full rounded-md bg-gray-100 pl-9 pr-3 text-sm transition-all duration-300 placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 sm:h-10 sm:pl-10 sm:pr-4 dark:bg-gray-800/80 ${className}`}
        />
      </div>
    </div>
  );
