...
function Login() {
  return (
    <div className="min-h-full flex-1 flex items-center justify-center bg-background px-4 py-2">
      <div className="w-full max-w-2xl overflow-hidden rounded-lg shadow-lg transition-all duration-300 dark:shadow-gray-800/20 sm:grid md:grid-cols-[0.6fr_1.4fr]">
        ...
        <div className="relative hidden overflow-hidden md:block">
          ...
          <div className="relative flex h-full flex-col justify-between p-6">
            <div>
              <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm shadow-inner">
            ...
            <div className="relative rounded-lg bg-white/10 p-2 backdrop-blur-sm">
